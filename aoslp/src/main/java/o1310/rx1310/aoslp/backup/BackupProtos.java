...
package o1310.rx1310.aoslp.backup;
...
public interface BackupProtos {
    ...
    public static final class Key extends
        ...
        public Key clear() {
            type = o1310.rx1310.aoslp.backup.BackupProtos.Key.FAVORITE;
            name = "";
            id = 0L;
            checksum = 0L;
            cachedSize = -1;
    ...
    public static final class Journal extends
        ...
        public o1310.rx1310.aoslp.backup.BackupProtos.Key[] key;
        ...
        public Journal clear() {
            ...
            bytes = 0L;
            rows = 0;
            key = o1310.rx1310.aoslp.backup.BackupProtos.Key.emptyArray();
            cachedSize = -1;
            return this;
        }
        ...
        public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
            ...
            if (this.key != null && this.key.length > 0) {
                for (int i = 0; i < this.key.length; i++) {
                    o1310.rx1310.aoslp.backup.BackupProtos.Key element = this.key[i];
                    if (element != null) {
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 42: {
                        ...
                        o1310.rx1310.aoslp.backup.BackupProtos.Key[] newArray =
                                new o1310.rx1310.aoslp.backup.BackupProtos.Key[i + arrayLength];
                        if (i != 0) {
                            java.lang.System.arraycopy(this.key, 0, newArray, 0, i);
                        }
                        for (; i < newArray.length - 1; i++) {
                            newArray[i] = new o1310.rx1310.aoslp.backup.BackupProtos.Key();
    ...
    public static final class Widget extends
        ...
        public o1310.rx1310.aoslp.backup.BackupProtos.Resource icon;

        // optional .launcher_backup.Resource preview = 5;
        public o1310.rx1310.aoslp.backup.BackupProtos.Resource preview;
        ...
        public Widget mergeFrom(
            ...
            while (true) {
                ...
                switch (tag) {
                    ...
                    case 34: {
                        if (this.icon == null) {
                            this.icon = new o1310.rx1310.aoslp.backup.BackupProtos.Resource();
                        }
                    ...
                    case 42: {
                        if (this.preview == null) {
                            this.preview = new o1310.rx1310.aoslp.backup.BackupProtos.Resource();
                        }
